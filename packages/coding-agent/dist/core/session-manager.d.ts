...
export interface SessionManager {
    ...
    branchWithSummary(branchFromId: string | null, summary: string, details?: unknown, fromHook?: boolean): Promise<string>;
 ...
 */
export declare class JsonlSessionManager implements SessionManager {
    private sessionId;
    private sessionFile;
    private sessionDir;
    private cwd;
    ...
    static inMemory(cwd?: string): JsonlSessionManager;
    /**
...
export declare const SessionManager: typeof JsonlSessionManager;
