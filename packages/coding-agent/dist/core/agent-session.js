...
export class AgentSession {
    ...
    async _processAgentEvent(event) {
        ...
        if (event.type === "message_end") {
            ...
            if (event.message.role === "custom") {
                ...
                await this.sessionManager.appendCustomMessageEntry(event.message.customType, event.message.content, event.message.display, event.message.details);
            }
    ...
    async sendCustomMessage(message, options) {
        ...
        if (options?.deliverAs === "nextTurn") {
            ...
            await this.sessionManager.appendCustomMessageEntry(message.customType, message.content, message.display, message.details);
    ...
    async navigateTree(targetId, options = {}) {
        ...
        if (summaryText) {
            ...
            const summaryId = await this.sessionManager.branchWithSummary(newLeafId, summaryText, summaryDetails, fromExtension);
