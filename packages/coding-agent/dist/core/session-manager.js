 ...
 */
export class JsonlSessionManager {
    sessionId = "";
    sessionFile;
    sessionDir;
    cwd;
    ...
    async setSessionFile(sessionFile) {
     ...
     */
    async appendLabelChange(targetId, label) {
     ...
     */
    async branchWithSummary(branchFromId, summary, details, fromHook) {
